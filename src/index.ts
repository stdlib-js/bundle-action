...
async function build(): Promise<void> {
	const command = [
		'find ./ -type f -name \'*.[jt]s\' -path "./lib/*" -path "./node_modules/@stdlib/*/lib/*" -print0 ', // Find all JavaScript and TypeScript files in the destination directory and print their full names to standard output...
